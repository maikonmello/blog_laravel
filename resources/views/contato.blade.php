                    ...
                    <div class="col-md-6">
                        <div class="block">
                            ...
                            <div class="contact-form">
                                <form id="contact-form" method="post" action="{{ route('mensagens') }}" role="form">
                                    ...
                                    <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1.2s">
                                        <textarea rows="6" placeholder="Message" class="form-control" name="body" id="message" required>
                                        </textarea>    
                                    </div>
                    ...
                    <div class="col-md-6">
                         <div class="map-area">
                            ...
                            <div class="map">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3613.3027505307346!2d-50.16198638544035!3d-25.09161102575626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94e81a3f797efa77%3A0xb3f067f1fab5c5d2!2sR.+J%C3%BAlia+Vanderlei+-+Centro%2C+Ponta+Grossa+-+PR!5e0!3m2!1spt-BR!2sbr!4v1507784042766" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
